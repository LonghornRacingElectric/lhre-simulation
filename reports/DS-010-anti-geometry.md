...
- [`outputs/run_provenance.csv`](../studies/DS-010-anti-geometry/outputs/run_provenance.csv)
- [`outputs/variants.csv`](../studies/DS-010-anti-geometry/outputs/variants.csv)
- [`outputs/fourpost_metrics.csv`](../studies/DS-010-anti-geometry/outputs/fourpost_metrics.csv)
- [`outputs/bin_scores.csv`](../studies/DS-010-anti-geometry/outputs/bin_scores.csv)
- [`outputs/anti_squat_summary.csv`](../studies/DS-010-anti-geometry/outputs/anti_squat_summary.csv)
- [`outputs/anti_dive_summary.csv`](../studies/DS-010-anti-geometry/outputs/anti_dive_summary.csv)
- [`outputs/validation.csv`](../studies/DS-010-anti-geometry/outputs/validation.csv)
- [`outputs/chosen_vehicle.yml`](../studies/DS-010-anti-geometry/outputs/chosen_vehicle.yml)

![anti_squat_objective.png](../studies/DS-010-anti-geometry/plots/anti_squat_objective.png)
![anti_dive_objective.png](../studies/DS-010-anti-geometry/plots/anti_dive_objective.png)
![validation_anti_vs_heave.png](../studies/DS-010-anti-geometry/plots/validation_anti_vs_heave.png)
![ride_height_vs_speed.png](../studies/DS-010-anti-geometry/plots/ride_height_vs_speed.png)
