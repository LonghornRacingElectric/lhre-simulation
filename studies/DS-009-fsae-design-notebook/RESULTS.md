...
| Figure | Path |
| --- | --- |
| Baseline capability summary | `plots/baseline_capability_summary.png` |
| Baseline platform summary | `plots/baseline_platform_summary.png` |
| Design lever map | `plots/design_lever_map.png` |
| Yaw authority and transient response | `plots/yaw_transient_summary.png` |
| Architecture design effects | `plots/architecture_design_effects.png` |
| Envelope sensitivity top drivers | `plots/envelope_sensitivity_top_drivers.png` |
| Standard sensitivity top drivers | `plots/standard_sensitivity_top_drivers.png` |
| Refined trade spaces | `plots/refined_trade_spaces.png` |
| Refined setup design region | `plots/refined_design_region.png` |
...
Detailed traceability table: `outputs/requirements_traceability.csv`.
...
Detailed assumption register: `outputs/assumption_register.csv`.
...
![Refined response trade spaces](plots/refined_trade_spaces.png)
...
Detailed design decision matrix: `outputs/design_decision_matrix.csv`.
...
Detailed risk controls: `outputs/risk_register.csv`.
...
Detailed verification matrix: `outputs/validation_matrix.csv`.
...
- `outputs/baseline_vehicle.csv`
- `outputs/baseline_response.csv`
- `outputs/requirements_traceability.csv`
- `outputs/assumption_register.csv`
- `outputs/risk_register.csv`
- `outputs/validation_matrix.csv`
- `outputs/design_review_checklist.csv`
- `outputs/design_decision_matrix.csv`
- `outputs/envelope_sensitivity_takeaways.csv`
- `outputs/standard_sensitivity_takeaways.csv`
- `outputs/refined_surface_selected_parameters.csv`
- `outputs/refined_response_surface_takeaways.csv`
- `plots/baseline_capability_summary.png`
- `plots/baseline_platform_summary.png`
- `plots/design_lever_map.png`
- `plots/yaw_transient_summary.png`
- `plots/architecture_design_effects.png`
- `plots/envelope_sensitivity_top_drivers.png`
- `plots/standard_sensitivity_top_drivers.png`
- `plots/refined_trade_spaces.png`
- `plots/refined_design_region.png`
