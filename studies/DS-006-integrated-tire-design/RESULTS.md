...
![Integrated score ranking across scoreable tire candidates](plots/integrated_score_rank.png)

### Current-package zero-radius-delta integrated ranking

![Current-package zero-radius-delta integrated ranking](plots/current_package_integrated_rank.png)

### Best scoreable setup by tire family

![Best scoreable setup by tire family](plots/family_best_score_comparison.png)

### Fitted peak lateral mu versus cornering stiffness

![Fitted peak lateral mu versus cornering stiffness](plots/tire_fit_mu_stiffness_map.png)

### Peak lateral mu and cornering stiffness by candidate

![Peak lateral mu and cornering stiffness by candidate](plots/tire_fit_mu_stiffness_rank.png)

### EnvelopeSim tire ranking

![EnvelopeSim tire ranking](plots/envelope_score_rank.png)

### StandardSim stable-window handling ranking

![StandardSim stable-window handling ranking](plots/standardsim_score_rank.png)

### Integrated tire trade space

![Integrated tire trade space](plots/integrated_trade_space.png)

### Pressure trends in EnvelopeSim and StandardSim score

![Pressure trends in EnvelopeSim and StandardSim score](plots/pressure_trends_vehicle_metrics.png)

### Lateral relaxation length ranking

![Lateral relaxation length ranking](plots/relaxation_rank.png)

### Relaxation length versus vehicle-level performance

![Relaxation length versus vehicle-level performance](plots/relaxation_trade_space.png)

### Transient tire-temperature evidence

![Transient tire-temperature evidence](plots/transient_temperature.png)

### Initial-to-final 12 psi cornering degradation

![Initial-to-final 12 psi cornering degradation](plots/tire_degradation_cornering.png)

### Initial-to-final 12 psi drive/brake degradation

![Initial-to-final 12 psi drive/brake degradation](plots/tire_degradation_drive_brake.png)
